    ...
    items: [
      { name: 'Main Motion', template: 'THAT Council [action]...', needs: 'Second required. Debatable. Majority vote.', hint: 'The primary proposal for council to consider.',
        example: { title: 'Award Contract', steps: [
          { role: 'Councillor Rabel', action: 'I move THAT Council awards the contract to Northern Landscapes in the amount of $78,500.' },
          { role: 'Councillor Johnston', action: 'I second.' },
      ...
      { name: 'Adopt/Approve', template: 'THAT Council adopts [item] as presented.', needs: 'Second required. Debatable. Majority vote.', hint: 'Used for agenda, minutes, reports, bylaws.',
        example: { title: 'Adopt Minutes', steps: [
          { role: 'Councillor Wall', action: 'I move THAT Council adopts the minutes of the March 11 meeting as presented.' },
          { role: 'Councillor Woodill', action: 'I second.' },
    ...
    items: [
      { name: 'Amend', template: 'THAT the main motion be amended by [adding/striking/substituting]...', needs: 'Second required. Debatable. Majority vote.', hint: 'Vote on amendment first, then main motion.',
        example: { title: 'Add Public Art to Contract', steps: [
          { role: 'Councillor Rabel', action: 'Moves main motion: award contract for $78,500.' },
          { role: 'Councillor Wall', action: 'I move THAT the main motion be amended by adding a public art component with $5,000 from reserves.' },
          { role: 'Councillor Woodill', action: 'I second the amendment.' },
      ...
      { name: 'Amend the Amendment', template: 'THAT the amendment be amended by...', needs: 'Second required. Debatable. Majority vote.', hint: 'Only one amendment to an amendment at a time.',
        example: { title: 'Change $5K to $3K', steps: [
          ...
          { role: 'Councillor Johnston', action: 'I move THAT the amendment be amended by changing $5,000 to $3,000.' },
          { role: 'Councillor Rabel', action: 'I second.' },
    ...
    items: [
      { name: 'Reconsider', template: 'THAT Council reconsiders the motion regarding [topic].', needs: 'Must be moved by someone on the prevailing side. Second required. Majority vote.', hint: 'Reopens a previously decided motion.',
        example: { title: 'Reconsider Rezoning', steps: [
          ...
          { role: 'Councillor Johnston', action: '(voted against) I move THAT Council reconsiders the motion regarding the rezoning of 102 Railway Ave.' },
          { role: 'Councillor Woodill', action: 'I second.' },
      ...
      { name: 'Rescind', template: 'THAT Council rescinds the motion regarding [topic] passed on [date].', needs: 'Second required. Two-thirds vote (or majority with notice).', hint: 'Cancels a previously adopted motion entirely.',
        example: { title: 'Rescind Fee Increase', steps: [
          { role: 'Councillor Wall', action: 'I move THAT Council rescinds the motion passed Jan 14 regarding the recreation fee increase.' },
          { role: 'Councillor Rabel', action: 'I second.' },
    ...
    items: [
      { name: 'Postpone Definitely', template: 'THAT Council postpones the matter to [date/meeting].', needs: 'Second required. Debatable. Majority vote.', hint: 'Delays to a specific future time.',
        example: { title: 'Postpone to April', steps: [
          { role: 'Councillor Rabel', action: 'I move THAT Council postpones the road budget to the April 2 regular meeting.' },
          { role: 'Councillor Wall', action: 'I second.' },
      ...
      { name: 'Table', template: 'THAT Council tables the matter.', needs: 'Second required. Not debatable. Majority vote.', hint: 'Sets aside. Can be taken from table later.',
        example: { title: 'Table Pending Report', steps: [
          { role: 'Councillor Johnston', action: 'I move THAT Council tables the matter pending a cost estimate from Public Works.' },
          { role: 'Councillor Woodill', action: 'I second.' },
      ...
      { name: 'Take from Table', template: 'THAT Council takes from the table the motion regarding [topic].', needs: 'Second required. Not debatable. Majority vote.', hint: 'Brings back a tabled motion.',
        example: { title: 'Resume Road Budget', steps: [
          { role: 'Councillor Rabel', action: 'I move THAT Council takes from the table the road maintenance budget motion.' },
          { role: 'Councillor Wall', action: 'I second.' },
    ...
    items: [
      { name: 'Refer to Committee', template: 'THAT Council refers the matter to [committee name] for review and report back.', needs: 'Second required. Debatable. Majority vote.', hint: 'Sends to committee for study.',
        example: { title: 'Refer Rezoning to Planning', steps: [
          { role: 'Councillor Wall', action: 'I move THAT Council refers the Pine Ave rezoning to the Planning Committee for review and report at the next meeting.' },
          { role: 'Councillor Rabel', action: 'I second.' },
      ...
      { name: 'Receive for Information', template: 'THAT Council receives [report/presentation] for information.', needs: 'Second required. Majority vote.', hint: 'Acknowledges receipt, no action taken.',
        example: { title: 'Receive CAO Report', steps: [
          { role: 'Councillor Johnston', action: "I move THAT Council receives the CAO's monthly report for information." },
          { role: 'Councillor Rabel', action: 'I second.' },
    ...
    items: [
      { name: 'Call the Question', template: 'THAT Council calls the question.', needs: 'Second required. Not debatable. Two-thirds vote.', hint: 'Ends debate, forces immediate vote.',
        example: { title: 'End Debate on Bylaw', steps: [
          { role: 'Councillor Woodill', action: 'I call the question.' },
          { role: 'Councillor Johnston', action: 'I second.' },
      ...
      { name: 'Point of Order', template: 'Point of order, Mayor.', needs: 'No second. Chair rules immediately.', hint: 'Raised when a rule is being violated.',
        example: { title: 'Speaker Out of Order', steps: [
          { role: 'Councillor Wall', action: 'Point of order, Mayor. The speaker is discussing a matter not on the agenda.' },
    ...
    items: [
      { name: 'First Reading', template: 'THAT Council gives [Bylaw #] first reading.', needs: 'Second required. Debatable. Majority vote.', hint: 'Introduction of the bylaw.',
        example: { title: 'Introduce Noise Bylaw', steps: [
          { role: 'Councillor Woodill', action: 'I move THAT Council gives Bylaw 1021, the Noise Control Amendment Bylaw, first reading.' },
          { role: 'Councillor Wall', action: 'I second.' },
      ...
      { name: 'Third Reading', template: 'THAT Council gives [Bylaw #] third and final reading.', needs: 'Second required. Debatable. Majority vote.', hint: 'Final adoption. Cannot be same meeting as 1st reading unless unanimous.',
        example: { title: 'Adopt Noise Bylaw', steps: [
          { role: 'Councillor Woodill', action: 'I move THAT Council gives Bylaw 1021 third and final reading.' },
          { role: 'Councillor Wall', action: 'I second.' },
          ...
          {[
            {
              ...
              flow: [
                { label: 'Main Motion', text: 'THAT Council awards the Main Street Beautification Project contract to Northern Landscapes in the amount of $78,500.', who: 'Moved: Councillor Rabel · Sec\'d: Councillor Johnston' },
                { label: 'Amendment', text: 'THAT the main motion be amended by adding "and that the project include a public art component with a budget allocation of up to $5,000 from the community enhancement reserve."', who: 'Moved: Councillor Wall · Sec\'d: Councillor Woodill' },
            ...
            },
            {
              ...
              flow: [
                { label: 'Main Motion', text: 'THAT Council approves a contribution of $3,000 from the events reserve to the Recreation Commission for the 2026 Canada Day celebration.', who: 'Moved: Councillor Johnston · Sec\'d: Councillor Woodill' },
                { label: 'Amendment', text: 'THAT the main motion be amended by reducing the contribution from $3,000 to $1,500 and directing the remaining $1,500 to the sidewalk repair reserve.', who: 'Moved: Councillor Wall · Sec\'d: Councillor Rabel' },
            ...
            },
            {
              ...
              flow: [
                { label: 'Original Motion', text: 'THAT Council directs staff to initiate a rezoning of the parcel at 102 Railway Avenue from R-1 to C-2 Commercial.', who: 'Moved: Councillor Wall · Sec\'d: Councillor Rabel' },
                { label: 'Original Vote', text: 'Defeated', isResult: true, color: '#dc2626' },
                { label: 'Reconsideration', text: 'THAT Council reconsiders the motion regarding the rezoning of 102 Railway Avenue, and THAT the matter be tabled to the next regular meeting pending a public consultation report.', who: 'Moved: Councillor Johnston · Sec\'d: Councillor Woodill' },
            ...
            },
            {
              ...
              flow: [
                { label: 'Main Motion', text: 'THAT Council approves the 2025 road maintenance budget of $142,000 as presented.', who: 'Moved: Councillor Johnston · Sec\'d: Mayor Veach' },
                { label: 'Motion to Table', text: 'THAT Council tables the matter pending a revised cost estimate from Public Works.', who: 'Moved: Councillor Rabel · Sec\'d: Councillor Wall' },
            ...
            },
            {
              ...
              flow: [
                { label: 'Main Motion', text: 'THAT Council approves the rezoning of 4820 Pine Ave from R1 to R2.', who: 'Moved: Councillor Johnston · Sec\'d: Councillor Woodill' },
                { label: 'Motion to Refer', text: 'THAT Council refers the Pine Avenue rezoning to the Planning Committee for review and report back at the next regular meeting.', who: 'Moved: Councillor Wall · Sec\'d: Councillor Rabel' },
            ...
            },
            {
              ...
              flow: [
                { label: 'Main Motion', text: 'THAT Council directs staff to draft a bylaw amendment extending permitted business hours to 11 PM on Fridays and Saturdays.', who: 'Moved: Councillor Wall · Sec\'d: Councillor Woodill' },
